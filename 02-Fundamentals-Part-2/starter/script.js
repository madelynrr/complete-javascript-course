...
const jonasArray = ["Madelyn", "Romero", 2037 - 1991, "teacher", ["Michael", "Peter", "Steven"], true];
const types = [];
const types2 = [];
...
const jonasArray = ["Madelyn", "Romero", 2037 - 1991, "Software Engineer", ["Michael", "Peter", "Steven"], true];
